...
import { catalog, getProductById, getRelatedProducts } from '@/lib/catalog';
            ...
            <section className="flex-1 pt-32 pb-20 md:pt-48 md:pb-32 relative z-20">
                <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 mb-32">
                        ...
                        >
                            <p className="font-montserrat text-[#BFA06A]/80 text-xs tracking-[0.3em] uppercase mb-4">
                                {product.material}
                            </p>
                            <h1 className="font-cormorant text-[#F0E6C2] font-light leading-none mb-6" style={{ fontSize: 'clamp(2.5rem, 4vw, 4.5rem)' }}>
                                {product.name}
                            </h1>
                            <p className="font-montserrat text-[#BFA06A] text-xl tracking-widest font-light mb-10">
                                {product.formattedPrice}
                            </p>
                            <p className="font-montserrat text-[#F0E6C2]/70 text-sm leading-relaxed font-light mb-12 max-w-xl">
                                {product.description}
                            </p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-6">
                                    <div className="flex items-center justify-between border border-[#BFA06A]/30 px-6 py-4 sm:w-1/3">
                                        <button
                                            ...
                                            className="text-[#F0E6C2]/50 hover:text-[#BFA06A] transition-colors"
                                        >-</button>
                                    ...
                                    <button
                                        ...
                                        className="btn-gold flex-1 justify-center text-[0.65rem] tracking-[0.25em]"
                                    >
                            ...
                            <div className="flex flex-col gap-6 font-montserrat text-xs text-[#F0E6C2]/60 font-light">
                                <div className="flex justify-between items-center py-4 border-b border-[#BFA06A]/10 cursor-pointer group">
                                    <span className="uppercase tracking-widest group-hover:text-[#BFA06A] transition-colors">Shipping & Returns</span>
                                    <span>+</span>
                                </div>
                                <div className="flex justify-between items-center py-4 border-b border-[#BFA06A]/10 cursor-pointer group">
                                    <span className="uppercase tracking-widest group-hover:text-[#BFA06A] transition-colors">Craftsmanship Guarantee</span>
                                    <span>+</span>
                                </div>
                                <div className="flex justify-between items-center py-4 border-b border-[#BFA06A]/10 cursor-pointer group">
                                    <span className="uppercase tracking-widest group-hover:text-[#BFA06A] transition-colors">Bespoke Options</span>
                                    <span>+</span>
                                </div>
                            </div>
                        </motion.div>
                                    ...
                                    >
                                        <Link href={`/product/${p.id}`} className="group block">
                                            ...
                                            <div className="text-center">
                                                <h3 className="font-cormorant text-[#F0E6C2] text-lg font-light mb-2 group-hover:text-[#BFA06A] transition-colors">
                                                    {p.name}
                                                </h3>
                                                <p className="font-montserrat text-[#BFA06A] text-xs tracking-widest">
                                                    {p.formattedPrice}
                                                </p>
                                            </div>
                                        </Link>

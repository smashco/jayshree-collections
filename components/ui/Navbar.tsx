...
const links = ['Collections', 'Heritage', 'Bespoke', 'Contact'];
            ...
            >
                <div className="max-w-[1400px] mx-auto px-8 md:px-16 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        {links.slice(0, 2).map((link) => (
                            <a
                                ...
                                className="font-montserrat text-[#F0E6C2]/50 font-light text-[0.6rem] tracking-[0.35em] uppercase hover:text-[#BFA06A] transition-all duration-500 relative group cursor-pointer"
                            >
                                {link}
                    ...
                    <a href="#" className="flex flex-col items-center group">
                        ...
                        <span className="font-montserrat text-[#BFA06A]/50 text-[0.45rem] tracking-[0.6em] uppercase font-light mt-0.5">
                            Maison · Est. 1976
                        </span>
                    </a>
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <button className="relative text-[#F0E6C2]/50 hover:text-[#BFA06A] transition-colors duration-400 cursor-pointer group" aria-label="Cart">
